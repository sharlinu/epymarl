...
class FACMACDiscreteLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            ...
            target_act_outs = th.nn.functional.one_hot(target_act_outs, num_classes=self.n_actions).float()
        ...
        for t in range(batch.max_seq_length - 1):
            ...
            act_outs = th.nn.functional.one_hot(act_outs, num_classes=self.n_actions).float()
